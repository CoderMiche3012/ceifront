...
const BASE_URL = "/api/beneficiarios/obligaciones";
...
export const obtenerObligacion = async (id) => {
  try {
...
//crear periodos
export const crearObligacion = async (payload) => {
  try {
...
export const actualizarObligacion = async (id, payload) => {
  try {
...
export const eliminarObligacion = async (id) => {
  try {
