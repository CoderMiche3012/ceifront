    ...
    switch (key) {
      ...
      case "comprobante":
        return item.comprobante ? (
          <a
            href={`http://localhost:8000${item.comprobante.archivo}`}
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex h-8 w-8 items-center justify-center rounded-full text-slate-400 hover:bg-blue-50 hover:text-blue-600 transition-all"
