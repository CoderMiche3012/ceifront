              ...
              <div className="space-y-6 animate-in fade-in duration-300">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-12 gap-x-4 gap-y-3">
                    ...
                    <div className="col-span-6 md:col-span-3"><Field label="Fecha Nac." required><InputG className={inputClass} type="date" max={new Date().toISOString().split("T")[0]} value={form.id_expediente.fecha_nacimiento} onChange={(e) => updateExpediente("fecha_nacimiento", e.target.value)} /></Field></div>
                      ...
                      <Field label="Nivel Escolar Inicial" required>
                        <select
                          ...
                          onChange={(e) =>
                            setForm((p) => ({
                              ...p,
                              nivel_escolar_inicial: e.target.value,
                            }))
                          }
                        >
