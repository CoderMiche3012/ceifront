...
import { useBeneficiarioCrearForm } from "../../../hooks/beneficiarios/useBeneficiarioCrearForm";
              ...
              <div className="space-y-8 animate-in fade-in slide-in-from-left-4 duration-300">
                ...
                <section>
                  ...
                  <div className="grid grid-cols-12 gap-x-4 gap-y-4">
                    ...
                    <div className="col-span-6 md:col-span-3"><Field label="Fecha Ingreso" required><InputG className={inputClass} type="date" value={form.fecha_ingreso} onChange={(e) => setForm(prev => ({ ...prev, fecha_ingreso: e.target.value }))} /></Field></div>
                  </div>
                </section>
                    ...
                    {form.id_expediente.familia.map((fam, idx) => (
                      <div key={idx} className={`p-6 rounded-2xl border-2 transition-all duration-300 ${idx === 0 ? 'border-[#0E5F63]/20 bg-white shadow-sm' : 'border-slate-50 bg-slate-50/30'}`}>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-x-4 gap-y-4">
                          ...
                          <Field label="Edad"><InputG className={inputClass} type="number" value={fam.edad} onChange={(e) => updateFamiliar(idx, "edad", e.target.value)} /></Field>
