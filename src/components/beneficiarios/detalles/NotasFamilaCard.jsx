...
export default function NotasFamilaCard({ data, setData }) {
    const [modalAbierto, setModalAbierto] = useState(false);
    const hayNota = data?.nota_situacion_familiar && data.nota_situacion_familiar.trim() !== "";
